 ...
 *
 */
public class Vaisseau8 extends Vaisseau {

	public Vaisseau8() {
		super("Vaisseau8");
		this.image = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau8.png");
		this.imageRotateRight = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau8droite.png");
		this.imageRotateLeft = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau8gauche.png");
		this.tailleX = 67;
		this.tailleY = 92;
