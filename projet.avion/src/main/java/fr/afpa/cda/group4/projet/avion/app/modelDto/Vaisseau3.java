...
public class Vaisseau3 extends Vaisseau {
	...
	public Vaisseau3() {
		super("Vaisseau3");
		this.image = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau3.png");
		this.imageRotateRight = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau3droite.png");
		this.imageRotateLeft = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau3gauche.png");
		this.tailleX = 46;
		this.tailleY = 96;
