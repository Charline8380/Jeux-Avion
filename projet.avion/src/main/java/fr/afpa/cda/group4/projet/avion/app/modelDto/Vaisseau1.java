...
public class Vaisseau1 extends Vaisseau {
	...
	public Vaisseau1() {
		super("Vaisseau1");
		this.image = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau1.png");
		this.imageRotateRight = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau1droite.png");
		this.imageRotateLeft = new File(Constantes.getDOSSIER_IMAGES() + "Fusee/Vaisseau1gauche.png");
		this.tailleX = 61;
		this.tailleY = 91;
